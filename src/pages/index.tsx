  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to E-Shirts, your ultimate platform for selling customized, trending T-shirts. Unleash your creativity, set your style, and let the world wear your imagination."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1581655353564-df123a1eb820?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0LXNoaXJ0c3xlbnwwfHx8fDE2OTE2NjI4NzN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@uyk?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Haryo Setyadi`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to E-Shirts, your ultimate platform for selling customized, trending T-shirts. Unleash your creativity, set your style, and let the world wear your imagination.`}
            </Text>
            <Box
